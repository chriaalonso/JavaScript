...
console.log(`Números ímpares do Array: ${oddNumbers}`)
...
console.log(`Quantidade de números abaixo de 501: ${numbersLessThan501}`)
...
console.log(`Números 5, 49 e 9 elevados ao quadrado: ${squareNumbers}`)
...
console.log("Filmes lançados antes do ano 2000:")
